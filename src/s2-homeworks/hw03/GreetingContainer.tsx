...
export const pureAddUser = (name: string, setError: (err: string | null) => void, setName: (n: string) => void, addUserCallback: (name: string) => void) => {
...
export const pureOnBlur = (name: string, setError: (err: string | null) => void) => { // если имя пустое - показать ошибку
    if (name.trim() === '') {
        setError('Ошибка! Введите имя!')
    }
}
